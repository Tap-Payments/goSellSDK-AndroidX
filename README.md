...
```java
	dependencies {
<<<<<<< HEAD
	        implementation 'com.github.Tap-Payments:goSellSDK-AndroidX:3.19.3'
=======
	        implementation 'com.github.Tap-Payments:goSellSDK-AndroidX:3.19.12'
>>>>>>> f848fec (fix for limit card length)
	}
```
