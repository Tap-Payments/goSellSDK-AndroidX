 ...
 * **/
    ...
    * */
    private void setupHeader() {
        ...
        //System.out.println("paymnet array" + PaymentDataManager.getInstance().getPaymentOptionsDataManager().getPaymentOptionsResponse().getPaymentOptions().get(3).getName());
